...
if __name__ == "__main__":
    ...
    # Define the Bedrock model ID you're using
    model_id = "meta.llama3-8b-instruct-v1:0"  # Adjust to the correct model ID available in Bedrock
    ...
    # Expand queries on user question using AWS Bedrock
    queries = query_expansion(lambda q: query_bedrock(model_id, q), user_question)

    # Retrieve most relevant docs pertaining to user_question
    ...
    # Generate teaching materials with qa_chain using Bedrock
    lesson_objects = generate_teaching_materials(lambda q: query_bedrock(model_id, q), user_question, context)
